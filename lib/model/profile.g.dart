...
const ProfileSchema = CollectionSchema(
  ...
  properties: {
    r'allergyCategory': PropertySchema(
      ...
      enumMap: _ProfileallergyCategoryEnumValueMap,
    ),
...
int _profileEstimateSize(
  ...
  bytesCount += 3 + object.allergyCategory.length * 3;
  {
    for (var i = 0; i < object.allergyCategory.length; i++) {
      final value = object.allergyCategory[i];
...
void _profileSerialize(
  ...
  writer.writeStringList(
      offsets[0], object.allergyCategory.map((e) => e.name).toList());
...
Profile _profileDeserialize(
  ...
  final object = Profile(
    allergyCategory: reader
            .readStringList(offsets[0])
            ?.map((e) =>
                _ProfileallergyCategoryValueEnumMap[e] ??
...
const _ProfileallergyCategoryEnumValueMap = {
  r'cowmilk': r'cowmilk',
  r'eggs': r'eggs',
  r'peanuts': r'peanuts',
  r'treenuts': r'treenuts',
  r'soy': r'soy',
  r'wheat': r'wheat',
  r'fish': r'fish',
  r'shellfish': r'shellfish',
  r'sesame': r'sesame',
  r'garlic': r'garlic',
  r'onion': r'onion',
};
const _ProfileallergyCategoryValueEnumMap = {
  r'cowmilk': FoodAllergyCategory.cowmilk,
  r'eggs': FoodAllergyCategory.eggs,
  r'peanuts': FoodAllergyCategory.peanuts,
  r'treenuts': FoodAllergyCategory.treenuts,
  r'soy': FoodAllergyCategory.soy,
  r'wheat': FoodAllergyCategory.wheat,
  r'fish': FoodAllergyCategory.fish,
  r'shellfish': FoodAllergyCategory.shellfish,
  r'sesame': FoodAllergyCategory.sesame,
  r'garlic': FoodAllergyCategory.garlic,
  r'onion': FoodAllergyCategory.onion,
};
...
extension ProfileQueryFilter
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition>
      allergyCategoryElementGreaterThan(
    FoodAllergyCategory value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition>
      allergyCategoryElementLessThan(
    FoodAllergyCategory value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition>
      allergyCategoryElementStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition>
      allergyCategoryElementEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition>
      allergyCategoryElementContains(String value,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition>
      allergyCategoryElementMatches(String pattern,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition>
      allergyCategoryElementIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'allergyCategory',
        value: '',
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition>
      allergyCategoryLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition>
      allergyCategoryLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileQueryWhereDistinct
  ...
  QueryBuilder<Profile, Profile, QDistinct> distinctByAllergyCategory() {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileQueryProperty
  ...
  QueryBuilder<Profile, List<FoodAllergyCategory>, QQueryOperations>
